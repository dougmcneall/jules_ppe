...
fast_tell_list <- vector(mode = 'list', length = length(emlist_km_Y_level1a))

for(i in 1:ncol(Y_level1a)){
  
  fit <- emlist_km_Y_level1a[[i]]
...
multiFAST<- function(X, Y, fit_list = NULL){
...
MF_Y_sum_level1a <- multiFAST(X = X_level1a, Y = Y_sum_level1a, fit_list = emlist_km_Y_level1a)
