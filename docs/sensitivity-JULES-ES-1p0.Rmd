...
MF_Y_sum_level1a <- multiFAST(X = X_level1a, Y = Y_sum_level1a, fit_list = emlist_km_Y_level1a, n = 1000)
...
Y_unif <- matrix(nrow = nsamp_unif, ncol = ncol(Y_const_level1a_scaled))
...
mcf_summary <- matrix(rbind(mcf_nbp, mcf_npp, mcf_cSoil, mcf_cVeg), nrow = ncol(Y_const_level1a_scaled))
