...
for(i in 1:d){
  ...
  hist(x2[,i], breaks = seq(from=0, to = 1, by = 0.1), col = zred, border = 'white', add = TRUE)
}
...
## Atmospheric growth
We can calculated the atmospheric growth as Fossil fule emissions (GCB) - Ocean uptake  (GCB) - net land flux (JULES NBP)
