...
"Level 3" constraints are tighter constraints from citeable sources produced by ER.
...
ylim = range(c(-100, 150))
matplot(years, t(cumulative_nbp), type = 'l', lty = 'solid',ylim = ylim, col = plotcol,
        ylab = 'GtC', main = 'cumulative NBP',
        bty = 'n')
matlines( years, t((cumulative_nbp[toplevel_to_level_1a_ix, ])[nbp_accum_ix, ]),col = overplotcol,lwd = 1.5, lty = 'solid')
