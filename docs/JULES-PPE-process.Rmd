...
At the moment, julesR is very much in development. Currently, you can use it to write an ensemble design, as explained in [this vignette](https://github.com/dougmcneall/julesR/blob/main/vignettes/write-jules-ensemble-design.Rmd)
