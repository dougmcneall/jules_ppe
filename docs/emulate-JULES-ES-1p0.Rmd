...
abline(0,1)
abline(v = clines_lower[i], col = 'grey')
abline(v = clines_upper[i], col = 'grey', lty = 'dashed')

abline(h = clines_lower[i], col = 'grey')
abline(h = clines_upper[i], col = 'grey', lty = 'dashed')
...
legend('top', legend = c('True positive', 'False Positive', 'False Negative', 'True Negative', 'lower bound', 'upper bound'), pch = c(19,19, 19, 21, NA, NA), col = c('blue', 'red', 'gold', 'grey', 'grey', 'grey'), lty = c(NA,NA,NA,NA, 'solid', 'dashed'), horiz = TRUE)
