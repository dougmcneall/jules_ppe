...
ix_test_set <- ix_kept_level5[c(head(level5_sort$ix,1) , tail(level5_sort$ix,2))]
...
legend('bottomleft', legend = c('wave01', 'wave01 level5', 'Test set', 'Standard'),  col = c(hcol_wave01, 'green', 'skyblue2', 'blue'), inset = c(0.2, 0.2), lty = 'solid' , lwd = 2)
