...
legend('bottomright', legend = c('wave01', 'wave01 level4'), lty = 'solid', lwd = 2, col = c(lcol_wave01, 'black'), inset = c(0.05, 0.15) )
...
const_mins_level5 <- c(35, 0, 750, 300, frac_cci_min['bare soil']*100, -50, treeFrac_cci_min)
const_maxes_level5 <- c(80, 10000, 3000, 800, frac_cci_max['bare soil']*100, 50, treeFrac_cci_max )
...
ix_test_set <- ix_kept_level5[c(head(level5_sort$ix,1), 19 ,31, tail(level5_sort$ix,1))]
...
# min is -175
# standard is 139.5
# could choose - 6 or 3.3 as something close to zero


```
## Level 5 CNPB, with selected test set members
Level 5 in green, test set in sky blue. Standard in dark blue
...
#matlines(sspyears, t(cnbp_ens_ssp585_S3[ix_kept_AW, ]), lty = 'solid', col = makeTransparent(hcol_wave01_level2, 250), lwd = 2)
#matlines(sspyears, t(cnbp_ens_ssp585_S3[ix_kept_AWBS, ]),lty = 'solid', col = makeTransparent(hcol_wave01_level3, 250), lwd = 2)
matlines(sspyears, t(cnbp_ens_ssp585_S3[ix_kept_level5, ]),lty = 'solid', col = makeTransparent('green', 90), lwd = 2)
matlines(sspyears, t(cnbp_ens_ssp585_S3[ix_test_set, ]),lty = 'solid', col = makeTransparent('skyblue2', 255), lwd = 2)
lines(sspyears, cnbp_ens_ssp585_S3[501, ],lty = 'solid', col = makeTransparent('blue', 250), lwd = 2)
...
linePlotMultiEns(years = sspyears, ens1 = get(yvec_ssp585[i]),
                 ...
                 col1 = lcol_wave01, col2 = 'skyblue2',
                 ylab = select_units[i], main = yvec_ssp585[i])
...
legend('bottomright', legend = c('wave01', 'wave01 selected'), lty = 'solid', lwd = 2, col = c(lcol_wave01, 'skyblue2'), inset = c(0.05, 0.15) )
