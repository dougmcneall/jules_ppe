...
for(i in 1:length(loolist_km_Y_level1a_all)){
...
text(Y_select_level1a_pmae, Y_select_wave00_level1a_wave01_pmae,
     labels = colnames(Y_select_level1a_wave01), pos = 3, cex = 0.6, col = 'darkgrey')
...
text(YAnom_select_level1a_pmae, YAnom_select_wave00_level1a_wave01_pmae, labels = colnames(YAnom_select_level1a_wave01),
