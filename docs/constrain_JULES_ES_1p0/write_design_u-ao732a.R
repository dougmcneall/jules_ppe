# Extra set of runs, to replace those that crashed in u-ao732
...
write_jules_design3(paramlist, n = 200,
                    fac = fac, minfac = minfac, maxfac = maxfac,
                    tf = tf,
                    fnprefix = 'conf_files_u-ao732a/param-perturb-P',
                    lhsfn = 'conf_files_u-ao732a/lhs_u-ao732a.txt',
                    stanfn = 'conf_files_u-ao732a/stanparms_u-ao732a.txt',
                    allstanfn = 'conf_files_u-ao732a/allstanparms_u-ao732a.txt',
                    rn = 12,
                    startnum = 300)
