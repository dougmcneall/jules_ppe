...
if (file.exists("ensemble_wave01_2022-04-05.rdata")) {
  load("ensemble_wave01_2022-04-05.rdata")
} else {
...
ens_wave01_mv <- makeJulesEnsembleModernValue(ensloc = ensloc_wave01, 
  ...
  save(ens_wave01_mv, file ="ensemble_wave01_2022-04-05.rdata")
}
...
if (file.exists("ensemble_timeseries_wave01_2022-04-05.rdata")) {
  load("ensemble_timeseries_wave01_2022-04-05.rdata")
} else {
  ...
  # # fractions
   ...
   save(npp_ens_wave01,
       ...
       file = "ensemble_timeseries_wave01_2022-04-05.rdata" )
}
