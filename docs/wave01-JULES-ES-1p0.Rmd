...
matplot(years, t(ag), type = 'l', lty = 'solid',ylim = c(0, 8), col = makeTransparent(wave00col,50), 
         ylab = 'GtC', main = 'atmospheric growth', xlab = '',
         bty = 'n', xlim = c(1960, 2020))

matlines(years, t(ag01), col = makeTransparent(wave01col,50), lty = 'solid')
...
legend('topleft', legend = c('wave00', 'wave01', 'standard', 'GCB'), col = c(wave00col, wave01col, stancol, obscol), lty = 'solid', lwd = 2)
#dev.off()
