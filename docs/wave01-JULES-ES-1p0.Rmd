...
plot(cnbp_modern_ens, agr_modern_ens, col = makeTransparent(wave00col,150),
     xlim = c(-120,220), pch = 19,
     xlab = 'Cumulative NBP from preindustrial by 1984-2013',
     ylab = 'Atmospheric growth rate 1984-2014')

cnbp_wave01_cols <- rep(wave01col, length(cnbp_modern_wave01))
cnbp_wave01_cols[level2_ix_wave01] <- wave01_level2col 

points(cnbp_modern_wave01, agr_modern_wave01, col = makeTransparent(cnbp_wave01_cols, 150), pch = 19)
points(cnbp_modern_stan, agr_stan, col = stancol, pch = 19, cex = 1.5)
