...
```{r, include = FALSE, eval=params$limit}
...
Y_pred_mins <- c(0, 35, 750, 300, 20, 0, 0, 0, 0)
Y_pred_maxes <- c(10000, 80, 3000, 800, 40, 100,100, 5, 40)
...
plot(1:5, frac_cci*100, ylim = c(0,50), pch = 19, cex = 1.5, axes = FALSE, xlab = '')
