...
#pdf(file = 'figs/ensemble_vs_expert_range_all_constraints.pdf', width = 10, height = 6)
main_vec <- c('NPP', 'NBP', 'cSoil', 'cVeg', 'trees', 'grassC3', 'grassC4', 'shrubs', 'baresoil')
par(mfrow = c(1, ncol(Y_const_ssp585_mv)), las = 1, mar = c(4,3,3,2))
...
#pdf(file = 'figs/pairs_all_constraints.pdf', width = 10, height = 10)
pairs(
...
cnbp_stan_ssp585_S3 <- cnbp_ens_ssp585_S3[501, ]

par(las= 1)
matplot(sspyears, t(cnbp_ens_ssp585_S3), type = 'l', lty = 'solid', col = alpha('black', 0.4),
        ylab = 'GtC', main = 'cumulative nbp', xlab = 'Year')
...
```{r}
cnbp_pred <- pca_km_pred(pc_km_cnbp_combine, X_new = X_unif[ix_kept_pred, ])
...
matlines(sspyears, t(cnbp_pred$Ypred), col = alpha(cbf_2[7], 0.6), lty = 'solid', lwd = 3)
...
## An interesting thing to do here - look at the difference between straight-emulated CNBP and PC emulated CNBP.
Do they match at time of observations?


## Predict the other variables

```{r}
pc_km_nbp <- pca_km(X = X_wave01_standard,
                             nbp_ens_ssp585_S3,
                             train_ix = train_ix, 
                             test_ix = test_ix, 
                             npctol = 0.99, 
...
pc_km_npp <- pca_km(X = X_wave01_standard,
                             npp_ens_ssp585_S3,
                             train_ix = train_ix, 
                             test_ix = test_ix, 
                             npctol = 0.99, 
...
pc_km_csoil <- pca_km(X = X_wave01_standard,
                             cSoil_ens_ssp585_S3,
                             train_ix = train_ix, 
                             test_ix = test_ix, 
                             npctol = 0.99, 
...
pc_km_cVeg <- pca_km(X = X_wave01_standard,
                             cVeg_ens_ssp585_S3,
                             train_ix = train_ix, 
                             test_ix = test_ix, 
                             npctol = 0.99, 
...
nbp_pred <- pca_km_pred(pc_km_nbp, X_new = X_unif[ix_kept_pred, ])
npp_pred <- pca_km_pred(pc_km_npp, X_new = X_unif[ix_kept_pred, ])
cSoil_pred <- pca_km_pred(pc_km_csoil, X_new = X_unif[ix_kept_pred, ])
cVeg_pred <- pca_km_pred(pc_km_cVeg, X_new = X_unif[ix_kept_pred, ])
```
...
matplot(sspyears, t(npp_ens_ssp585_S3), type = 'l', lty = 'solid', col = alpha(cbf_2[1], 0.4),
        ylab = 'GtC', xlab = 'year', main = 'npp', lwd =2)
matlines(sspyears, t(npp_pred$Ypred), col = alpha(cbf_2[7], 0.6), lty = 'solid', lwd = 3)
matlines(sspyears, t(npp_ens_ssp585_S3[ix_kept_all, ]), col = cbf_2[3], lwd = 3, lty = 'solid')
matlines(sspyears, npp_ens_ssp585_S3[501, ],  col  = cbf_2[2], lwd = 3)


matplot(sspyears, t(cSoil_ens_ssp585_S3), type = 'l', lty = 'solid', col = alpha(cbf_2[1], 0.4),
        ylab = 'GtC', xlab = 'year', main = 'cSoil', lwd =2)
matlines(sspyears, t(cSoil_pred$Ypred), col = alpha(cbf_2[7], 0.6), lty = 'solid', lwd = 3)
matlines(sspyears, t(cSoil_ens_ssp585_S3[ix_kept_all, ]), col = cbf_2[3], lwd = 3, lty = 'solid')
matlines(sspyears, cSoil_ens_ssp585_S3[501, ],  col  = cbf_2[2], lwd = 3)


matplot(sspyears, t(cVeg_ens_ssp585_S3), type = 'l', lty = 'solid', col = alpha(cbf_2[1], 0.4),
        ylab = 'GtC', xlab = 'year', main = 'cVeg', lwd =2)
matlines(sspyears, t(cVeg_pred$Ypred), col = alpha(cbf_2[7], 0.6), lty = 'solid', lwd = 3)
matlines(sspyears, t(cVeg_ens_ssp585_S3[ix_kept_all, ]), col = cbf_2[3], lwd = 3, lty = 'solid')
matlines(sspyears, cVeg_ens_ssp585_S3[501, ],  col  = cbf_2[2], lwd = 3)
...
par(las= 1, mfrow = c(1,4))
matplot(sspyears, t(nbp_ens_ssp585_S3), type = 'l', lty = 'solid', col = alpha(cbf_2[1], 0.4),
        ylab = 'GtC/year', xlab = 'year', main = 'nbp', lwd =2)
matlines(sspyears, t(nbp_pred$Ypred), col = alpha(cbf_2[7], 0.6), lty = 'solid', lwd = 2)
matlines(sspyears, t(nbp_ens_ssp585_S3[ix_kept_all, ]), col = cbf_2[3], lwd = 2, lty = 'solid')
matlines(sspyears, nbp_ens_ssp585_S3[501, ],  col  = cbf_2[2], lwd = 2)
#matlines(sspyears, nbp_stan_ssp585_S3,  col  = cbf_2[2], lwd = 3)
#matlines(match_years, cumulative_net_land_sink, col = cbf_2[5], lwd = 3)
...
matplot(sspyears, t(npp_ens_ssp585_S3), type = 'l', lty = 'solid', col = alpha(cbf_2[1], 0.4),
        ylab = 'GtC/year', xlab = 'year', main = 'npp', lwd =2)
matlines(sspyears, t(npp_pred$Ypred), col = alpha(cbf_2[7], 0.6), lty = 'solid', lwd = 3)
matlines(sspyears, t(npp_ens_ssp585_S3[ix_kept_all, ]), col = cbf_2[3], lwd = 3, lty = 'solid')
matlines(sspyears, npp_ens_ssp585_S3[501, ],  col  = cbf_2[2], lwd = 3)
...
# 
#   ens <- get(yvec_ssp585[i])
#        
#   pca_km_obj <- pca_km(X = X_wave01_standard,
#                              ens,
#                              train_ix = train_ix, 
#                              test_ix = test_ix, 
#                              npctol = 0.99, 
...
#                              center = TRUE)
# 
#   assign(paste0('pc_km',y_names_select_ssp585[i]), pca_km_obj)
#   
# 
#   pred <- pca_km_pred(pca_km_obj, X_new = X_unif[ix_kept_pred, ])
#   
#   assign(paste0('pred',y_names_select_ssp585[i]), pred)
# 
# }
...
#save(ls(pattern = 'pred'), file = 'pred.Rmd')
